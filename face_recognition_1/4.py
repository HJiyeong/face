...
if __name__ == "__main__":
    ...
    output_json_file = '/Users/hwangjiyeong/PycharmProjects/facial reconition/face_recognition_1/test_data/landmark_test_data6'  # 결과를 저장할 JSON 파일
    ...
    image_path = '/Users/hwangjiyeong/PycharmProjects/facial reconition/face_recognition_1/test_data/karina_t.png'
    landmarks_data = extract_landmarks(image_path, predictor)

    # 데이터셋을 JSON 파일로 저장
    save_landmarks_to_json(landmarks_data, output_json_file)
