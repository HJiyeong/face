...
def rotate_image(image, landmarks):
    ...
    '''
    # forehead_center 계산 (V1과 V2는 bounding box의 모서리 좌표)
    V1 = (landmarks.part(0).x, landmarks.part(19).y)
    V2 = (landmarks.part(2).x, landmarks.part(24).y)
    fx = (V1[0] + V2[0]) // 2
    fy = (V1[1] + V2[1]) // 2
    forehead_center = (fx, fy)
    '''
...
if __name__ == "__main__":
    ...
    output_json_file = '/face_recognition_1/landmark/landmark_datas'  # 결과를 저장할 JSON 파일
